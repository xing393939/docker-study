...
1. docker run --network subnet01 --name container-php-fpm7172 -p 9001:9000 -v /mnt/f/APICloud:/code -d image-php-fpm7172
1. docker build -t image-ng7172 .
1. docker run --network subnet01 --name container-ng7172 -p 71:71 -d image-ng7172
