...
* CRD，自定义API对象network的例子：
  * kubectl apply定义apiVersion=samplecrd.k8s.io，kind=Network
  * go get -u k8s.io/code-generator/...
  * 必须在code-generator目录运行命令：./generate-groups.sh all {目标目录} {基于$GOPATH的相对目录} {包名:版本号}
